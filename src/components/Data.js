...
const columns = [
  ...
  const rows = [
    ...
    { id: 2, pageURL: 'Lannister', pageTitle: 'Cersei', datePublished: 15, metaData: 'gtygfdrdddsgh', todayVisit: 20, oneWeekVisit: 40, oneMonthVisit: '<View/>', view: <button className='btn btn-primary'>View</button> },
